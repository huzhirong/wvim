...
let g:vimwiki_list = [{'path': 'D:/vimwiki/wiki_techno/', 'path_html': 'D:/vimwiki/wiki_techno/html/', 'auto_export': 1},{'path': 'D:/vimwiki/wiki_literature/', 'path_html': 'D:/vimwiki/wiki_literature/html/', 'auto_export': 1}]
